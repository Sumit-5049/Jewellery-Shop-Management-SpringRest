...
import com.jsm.service.ReturnReqService;
...
//output: String msg
	@PostMapping("/add")
	public ResponseEntity<?> register(@RequestBody ReturnReq r,@RequestHeader(name = "Authorization" ) String tokenDup) throws StockUnavailableException, DataNotFoundException, WrongFormatException, NotPossibleException, DuplicateException {
